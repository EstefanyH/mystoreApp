...
public class ProductoCliAdapter extends RecyclerView.Adapter<ProductoCliAdapter.ViewHolder> {

    List<Producto> lista ;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    public ProductoCliAdapter(Context context, List<Producto> items) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_cli_producto, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int pos) {
        holder.txt_cli_producto.setText(lista.get(pos).getNombre());
        holder.txt_cli_tienda.setText(lista.get(pos).getTienda());
        holder.txt_cli_detalle.setText(lista.get(pos).getDetalle());
        holder.txt_cli_precio.setText(lista.get(pos).getCosto());
